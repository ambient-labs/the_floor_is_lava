...
import { withWorkingDir, } from '../../packages/the_floor_is_lava/src/bundlers/utils/with-working-dir.js';
import * as _withWorkingDir from '../../packages/the_floor_is_lava/src/bundlers/utils/with-working-dir.js';
import { writeFile, } from '../../packages/the_floor_is_lava/src/common/fs.js';
import * as _fs from '../../packages/the_floor_is_lava/src/common/fs.js';

vi.mock("../../packages/the_floor_is_lava/src/bundlers/utils/with-working-dir.js", async () => {
  const actual = await vi.importActual("../../packages/the_floor_is_lava/src/bundlers/utils/with-working-dir.js") as typeof _withWorkingDir;
  return {
    ...actual,
  };
});

vi.mock("../../packages/the_floor_is_lava/src/common/fs.js", async () => {
  const actual = await vi.importActual("../../packages/the_floor_is_lava/src/common/fs.js") as typeof _fs;
  return {
    ...actual,
  };
});
